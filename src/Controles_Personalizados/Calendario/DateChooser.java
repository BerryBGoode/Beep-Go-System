...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new Controles_Personalizados.Calendario.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new Controles_Personalizados.Calendario.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new Controles_Personalizados.Calendario.Button();
        cmdPrevious = new Controles_Personalizados.Calendario.Button();
        slide = new Controles_Personalizados.Calendario.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Controles_Personalizados/Calendario/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Controles_Personalizados/Calendario/previous.png"))); // NOI18N
    ...
    private Controles_Personalizados.Calendario.Button cmdForward;
    private Controles_Personalizados.Calendario.Button cmdMonth;
    private Controles_Personalizados.Calendario.Button cmdPrevious;
    private Controles_Personalizados.Calendario.Button cmdYear;

...
public Image Logo(){
    ...
    private void initComponents() {
        ...
        txtnoCarnet = new Controles_Personalizados.textfields.TextField();
        ...
        txtnoCarnet.setBackground(new java.awt.Color(58, 50, 75));
        txtnoCarnet.setForeground(new java.awt.Color(253, 255, 254));
        txtnoCarnet.setCaretColor(new java.awt.Color(253, 255, 254));
        txtnoCarnet.setDisabledTextColor(new java.awt.Color(253, 255, 254));
        txtnoCarnet.setFont(new java.awt.Font("Roboto Light", 0, 18)); // NOI18N
        txtnoCarnet.setLabelText("No. Carnet");
        txtnoCarnet.setLineColor(new java.awt.Color(253, 255, 254));
        txtnoCarnet.setSelectedTextColor(new java.awt.Color(58, 50, 75));
        txtnoCarnet.setSelectionColor(new java.awt.Color(253, 255, 254));
        panelRound1.add(txtnoCarnet, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 450, 70));
    ...
    private Controles_Personalizados.textfields.TextField txtnoCarnet;
